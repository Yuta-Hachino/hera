...
# メッセージ7: 全部
```
curl -X POST http://localhost:8080/api/sessions/{SESSION_ID}/messages \ -H "Content-Type: application/json" \ -d '{"message": " こんにちは 20歳独身男性です。 奥さんと子供二人（男女）が欲しいです。 年収は300万で足立区に住んでます。 職業はエンジニアで普段はコワーキングスペースで仕事をしていて週一で出勤しています。 将来は家族みんなで動物園に行きたいです。 お仕事がお休みの日は、猫と遊んだりユーチューブを見ます 秋葉原で友人と飲んだり、焼肉に行くことは多いです。 エンジニアの友人と勉強会もします 将来はAI技術を極めて月単価を140万にしたいです。 奥さんの顔はいつもニコニコして顔は薄く色白がいいです。 嘘をつかない誠実さと天真爛漫さを兼ね備えた人が理想です。 私はすごいネガティブですが頑張り屋です "}'
```
