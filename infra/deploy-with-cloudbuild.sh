...
# 環境変数設定
ENV_VARS="SESSION_TYPE=firebase,STORAGE_MODE=cloud,CLOUD_STORAGE_TYPE=gcs,GCS_BUCKET_NAME=test-6554c.firebasestorage.app,FLASK_DEBUG=False,ALLOWED_ORIGINS=*,FIREBASE_PROJECT_ID=test-6554c,FIREBASE_STORAGE_BUCKET=test-6554c.firebasestorage.app,GEMINI_LIVE_MODE=$LIVE_API_MODE"
