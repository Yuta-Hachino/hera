...
### 音声フォーマット仕様
| 方向 | フォーマット | サンプルレート | ビット深度 | チャンネル | エンディアン | MIME Type | デフォルト |
|------|------------|--------------|-----------|----------|------------|-----------|-----------|
| **入力** | Raw PCM | 16kHz | 16-bit | Mono | Little-endian | `audio/pcm;rate=16000` | **OFF** |
| **出力** | Raw PCM | 24kHz | 16-bit | Mono | Little-endian | `audio/pcm;rate=24000` | **ON** |
